...
impl Allocation {
    pub fn from_allocation_item(allocation_item: AllocationItem) -> Allocation {
        Allocation { id: allocation_item.id, description: allocation_item.description, date_of_entry: allocation_item.date_of_entry, can_be_outside: allocation_item.can_be_outside, storage_box_id: allocation_item.storage_box_id }
    }
}
